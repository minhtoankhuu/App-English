...
EXERCISE_INSTRUCTIONS: dict[str, str] = {
    "pronunciation": (
        "Dạng chọn từ có phần phát âm khác 3 từ còn lại. Có 3 KIỂU thường gặp — chọn 1 kiểu "
        "phù hợp nhất với từ vựng có sẵn trong nguồn cho mỗi câu (không cần dùng cùng 1 kiểu "
        "cho mọi câu nếu sinh nhiều câu cùng lúc):\n"
        ...
        "đứng trước — vd 'watch<u>ed</u>' /t/, 'lov<u>ed</u>' /d/, 'want<u>ed</u>' /ɪd/.\n"
        ...
        "để so sánh phát âm). Trong mỗi option.text, bọc đúng phần đang so sánh (đuôi -s/-es, "
        "đuôi -ed, hoặc cụm chữ cái) bằng <u>...</u>. Giải thích nêu rõ ký hiệu IPA khác biệt."
    ),
    "stress": (
