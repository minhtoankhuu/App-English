...
EXERCISE_INSTRUCTIONS: dict[str, str] = {
    "pronunciation": (
        "Dạng chọn từ có phần phát âm khác 3 từ còn lại. BẮT BUỘC: 4 lựa chọn phải là 4 TỪ "
        "ĐƠN (không phải cụm từ/câu) cùng chứa MỘT cụm chữ cái giống nhau ở vị trí tương ứng "
        "(vd cùng có 'ea', cùng có đuôi '-ed', cùng có 's' cuối...) — 3 từ phát âm cụm đó "
        "giống nhau, đúng 1 từ phát âm khác (đó là đáp án đúng). Trong mỗi option.text, bọc "
        "chính xác cụm chữ cái đang so sánh bằng <u>...</u>. Ví dụ 4 lựa chọn hợp lệ: "
        "'cl<u>ea</u>n', 'br<u>ea</u>d', 't<u>ea</u>ch', 't<u>ea</u>m' — đáp án 'bread' vì "
        "phát âm /e/, ba từ còn lại /iː/. KHÔNG được chọn 4 từ/cụm từ không liên quan nhau "
        "về chính tả (vd không được so sánh 'gardening' với 'free time' — không có điểm "
        "chung để so sánh phát âm). Giải thích nêu rõ ký hiệu IPA khác biệt."
    ),
    "stress": (
